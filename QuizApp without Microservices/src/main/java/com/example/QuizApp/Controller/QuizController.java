...
public class QuizController {
    ...
    public ResponseEntity<Integer> submitQuiz(@PathVariable("id") int quizId,@RequestBody List<ResponseQuizDTO> responseQuizDTOS){
        int result = quizService.calculateResult(quizId,responseQuizDTOS);
